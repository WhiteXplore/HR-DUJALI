  ...
  >
    <div class="rounded-xl shadow-lg w-full max-w-7xl bg-white">
      <div class="w-auto bg-white text-[14px] rounded-[15px] shadow-lg">
        ...
        <!-- Content Here  -->
        <div class="h-auto overflow-y-auto p-5 space-y-4">
          <!-- Row 1 -->
          ...
          <div class="w-full mb-6">
            <div
              class="overflow-x-auto border border-gray-300 rounded-lg max-h-[250px]"
            >
              <table
          ...
          <div class="flex justify-end space-x-2 w-full">
            <button
              class="bg-red-700 hover:bg-red-600 text-white text-sm px-3 py-2 rounded transition"
              @click="closeModal"
            >
              Close
            </button>
            <button
              class="bg-blue-700 hover:bg-blue-600 text-white text-sm px-4 py-2 rounded transition"
              @click="submitData"
            >
              Submit All Data
            </button>
...
export default {
  ...
  methods: {
    ...
    sanitizeForm() {
      ...
      this.form.employee_id = this.fillNA(this.form.employee_id);
      this.form.department = this.fillNA(this.form.department);
