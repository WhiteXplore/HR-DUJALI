<template>
  <div
    class="flex flex-col items-center justify-center bg-gray-100 p-4 overflow-auto mt-3 rounded-xl"
  >
      ...
      <div class="flex justify-center w-full mt-2">
        ...
        >
          ...
          >
            ...
            <div class="text-[16px] mt-10 font-sans">
              <p class="text-justify mb-6">
                ...
                <span
                  ...
                  dir="ltr"
                  @input="employeeName = $event.target.innerText"
                  ref="employeeName"
                  class="ml-1 font-semibold bg-transparent placeholder-gray-900 inline-block"
                ></span
                ...
                <span
                  contenteditable="true"
                  dir="ltr"
                  @input="employeeDate = $event.target.innerText"
                  ref="employeeDate"
                  class="ml-1 font-semibold bg-transparent placeholder-gray-900 inline-block"
                ></span>
                to Present.
              ...
              <p class="text-justify mb-6">
                ...
                <span
                  contenteditable="true"
                  dir="ltr"
                  @input="employeeLastName = $event.target.innerText"
              ...
              <p class="text-justify mb-6">
                ...
                <span
                  contenteditable="true"
                  dir="ltr"
                  @input="employeeDay = $event.target.innerText"
                  ref="employeeDay"
                  class="ml-1 font-semibold bg-transparent placeholder-gray-900 inline-block"
                ></span>
                day of
                <span
                  contenteditable="true"
                  dir="ltr"
                  @input="employeeMonth = $event.target.innerText"
                  ref="employeeMonth"
                  class="ml-1 font-semibold bg-transparent placeholder-gray-900 inline-block"
                ></span
                >,
                <span
                  contenteditable="true"
                  dir="ltr"
                  @input="employeeYear = $event.target.innerText"
                  ref="employeeYear"
                  class="ml-1 font-semibold bg-transparent placeholder-gray-900 inline-block"
                ></span>
            ...
            <div class="mt-[400px] flex flex-col items-end font-bold">
...
export default {
  ...
  mounted() {
    ...
    this.$refs.employeeDay.innerText = this.employeeDay;
